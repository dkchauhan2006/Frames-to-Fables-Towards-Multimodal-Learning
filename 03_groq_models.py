"""
Story Generation using Groq API — Llama3, Gemma2, DeepSeek-R1
...
Requirements:
    ...
    All models below are FREE on Groq.
"""
...
def generate_story(model_id: str, model_label: str, client: Groq) -> str:
    """Generate a story using a Groq-hosted model."""
    print(f"\n{'='*60}")
...
def main():
    ...
    results = {}
    for model_id, model_label in GROQ_MODELS.items():
        try:
    ...
    with open("stories/groq_stories.json", "w") as f:
        json.dump(results, f, indent=2)
    print("\n✓ All Groq stories saved to stories/groq_stories.json")
    return results
